    ...
    <div className="container-fluid mt-5 ">
      <div className="row">
        <div className="col-md-6 d-flex align-items-center ps-5 justify-content-center">
          <p className="pt-5 text-white fs-3 ">
            Hello there! 👋 My name is Dijana, and I am an enthusiastic React JS
            developer.
            <p>
            ...
            <p>
              ...
              knowledge. My ultimate goal is to become an experienced frontend
